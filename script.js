...
window.exportToPDF = async function () {
    ...
    const originalResultsDisplay = resultsSection ? resultsSection.style.display : 'none';
    ...
    try {
        ...
        const canvas = await html2canvas(targetElement, {
            ...
            useCORS: true,
            logging: false,
            backgroundColor: '#f9fafb', // 배경색 지정 (Tailwind gray-50 유사)
