        ...
        "data": {
            "10000": [ // 1억원
                { name: "(비급여) 암 수술비", amount: "1,000만" },
                {
                    name: "(비급여) 다빈치 로봇 수술비",
                    amount: "2,000만",
                    sub: ["(비급여) 수술비 1,000만", "(비급여) 다빈치 로봇수술 1,000만"]
                },
            ...
            "7000": [ // 7천만원
                { name: "(비급여) 수술비", amount: "750만" },
                {
                    name: "(비급여) 다빈치 로봇 수술비",
                    amount: "1,500만",
                    sub: ["(비급여) 수술비 750만", "(비급여) 다빈치 로봇수술 750만"]
                },
            ...
            "4000": [ // 4천만원
                { name: "(비급여) 수술비", amount: "500만" },
                {
                    name: "(비급여) 다빈치 로봇 수술비",
                    amount: "1,000만",
                    sub: ["(비급여) 수술비 500만", "(비급여) 다빈치 로봇수술 500만"]
                },
